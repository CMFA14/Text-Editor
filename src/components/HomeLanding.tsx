...
export default function HomeLanding({
  files, onCreate, onOpenFiles, onOpenFile, onOpenSettings,
}: HomeLandingProps) {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {PRODUCTS.map(p => (
            <button
              ...
              className={`group text-left p-5 rounded-2xl bg-white dark:bg-slate-800/60 border border-[var(--border-light)] ${p.hoverBorder} transition-all shadow-sm hover:shadow-lg hover:-translate-y-1`}
            >
